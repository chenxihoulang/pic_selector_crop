 ...
 * <p>
 * 参考博文:
 * 作者原文:https://yalantis.com/blog/how-we-created-ucrop-our-own-image-cropping-library-for-android/
 * 原文翻译:https://blog.csdn.net/wood_water_peng/article/details/51306274
 */
public class UCrop {
     ...
     *
     * @param source      Uri for image to crop 输入图片的Uri
     * @param destination Uri for saving the cropped image 输出图片的Uri
     */
    ...
    public static class Options {
         ...
         * 设置裁剪的图片质量，取值0-100
         */
        public void setCompressionQuality(@IntRange(from = 0, to = 100) int compressQuality) {
